...
public class Quote {
    ...
    private Double eps; // Can be null
    private Double pe;  // Can be null
    private String earningsAnnouncement; // Can be null
    private Long sharesOutstanding; // Can be null
    ...
    // You can generate these in your IDE (e.g., Alt+Insert in IntelliJ, Source -> Generate Getters and Setters in Eclipse)
